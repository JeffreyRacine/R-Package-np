...
arguments remain under `Search Initialization, Kernels, And Support`.
MPI-specific startup and gallery guidance remains on the npRmpi pages. No
function signatures, defaults, or MPI lifecycle semantics were changed.
