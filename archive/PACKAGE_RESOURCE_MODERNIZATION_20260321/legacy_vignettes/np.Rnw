...
Network at \url{https://CRAN.R-project.org/package=np}.
...
\code{plot} & General Purpose Plotting of Nonparametric Objects& \\
...
objects, \code{plot} (via class-specific S3 methods) is dynamic; i.e., you
...
document 
(\url{https://CRAN.R-project.org/package=np/vignettes/np_faq.pdf}) for a range of
...
the class-specific S3 \code{plot} methods. The lower left and lower right plots in Figure~\ref{age
...
Engineering Research Council of Canada (\url{https://nserc-crsng.canada.ca/}),
the Social Sciences and Humanities Research Council of Canada
(\url{https://sshrc-crsh.canada.ca/}), and the Shared Hierarchical Academic
Research Computing Network (\url{https://www.sharcnet.ca/}).
