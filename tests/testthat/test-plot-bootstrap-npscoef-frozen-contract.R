npscoef_semiparam_frozen_contract_case <- function() {
  ...
  lines <- c(
    ...
    "  expected.plot <- plot(bw, xdat = xdat, ydat = y, zdat = zdat, neval = 6L, coef = FALSE, behavior = 'data')",
    ...
    "  capture.output(plot(bw, xdat = xdat, ydat = y, zdat = zdat, neval = 6L, coef = FALSE, behavior = 'data', errors = 'bootstrap', bootstrap = 'inid', boot_control = np_boot_control(nonfixed = 'frozen'), B = 41L, band = 'pointwise'))",
