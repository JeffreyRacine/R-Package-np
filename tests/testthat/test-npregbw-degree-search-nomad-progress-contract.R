...
test_that("npregbw NOMAD plus Powell progress keeps lines compact and restart-oriented", {
  ...
  expect_true(any(grepl("^\\[(np|npRmpi)\\] (Selecting degree and bandwidth|NOMAD degree/bw|Exhaustive degree/bw|Auto:NOMAD degree/bw|Auto:exhaustive degree/bw) \\(", msgs)))
