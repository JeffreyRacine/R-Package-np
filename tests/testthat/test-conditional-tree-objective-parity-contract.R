test_that("conditional tree objectives preserve observation identities", {
  ...
  npcdensbw <- getFromNamespace("npcdensbw", "npRmpi")
  npcdistbw <- getFromNamespace("npcdistbw", "npRmpi")
  density.eval <- getFromNamespace(".npcdensbw_eval_only", "npRmpi")
  distribution.eval <- getFromNamespace(".npcdistbw_eval_only", "npRmpi")
