test_that("native categorical coordinates replay public objectives exactly", {
  ...
  udens_replay <- npRmpi:::npudensbw.bandwidth(
  ...
  udist_replay <- npRmpi:::npudistbw.dbandwidth(
  ...
  cdens_replay <- npRmpi:::.npcdensbw_eval_only(
  ...
  cdist_replay <- npRmpi:::.npcdistbw_eval_only(
