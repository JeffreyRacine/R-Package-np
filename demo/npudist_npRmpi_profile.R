...
.np_demo_family <- c(if (nzchar(.np_demo_src)) file.path(.np_demo_src, "..", "inst", "demo_family_npudist.R"),
                     system.file("demo_family_npudist.R", package = "npRmpi"))
...
npudist_demo_run_matrix("profile")
