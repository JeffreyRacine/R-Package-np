...
```bash
Rscript /Users/jracine/Development/np-master/benchmarks/npreg/make_npreg_report.R \
...
After producing the `npRmpi` comparison CSV files (see `/Users/jracine/Development/np-npRmpi/benchmarks/npreg/REPRODUCE.md`), run:

```bash
Rscript /Users/jracine/Development/np-master/benchmarks/npreg/make_npreg_combined_report.R \
