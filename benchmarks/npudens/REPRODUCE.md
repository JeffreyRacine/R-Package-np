...
```bash
Rscript /Users/jracine/Development/np-master/benchmarks/npudens/compare_npudens_versions.R \
...
```bash
Rscript /Users/jracine/Development/np-master/benchmarks/npudens/make_npudens_report.R \
