...
parse_args <- function(args) {
  out <- list(
    ...
    label_a = "A",
    label_b = "B",
    out_timing = "/tmp/npscoef_version_timing_compare.csv",
    out_objective = "/tmp/npscoef_version_objective_compare.csv",
    out_combo_timing = "/tmp/npscoef_version_combo_timing_compare.csv",
    out_combo_objective = "/tmp/npscoef_version_combo_objective_compare.csv"
  )
  for (a in args) {
...
mk_timing <- function(df, label) {
  data.frame(
    function_name = c("npscoefbw", "npscoef", "npscoef_total"),
