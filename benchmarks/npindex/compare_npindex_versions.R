...
parse_args <- function(args) {
  out <- list(
    ...
    label_a = "A",
    label_b = "B",
    out_timing = "/tmp/npindex_version_timing_compare.csv",
    out_objective = "/tmp/npindex_version_objective_compare.csv",
    out_combo_timing = "/tmp/npindex_version_combo_timing_compare.csv",
    out_combo_objective = "/tmp/npindex_version_combo_objective_compare.csv"
  )
  for (a in args) {
...
mk_timing <- function(df, label) {
  data.frame(
    function_name = c("npindexbw", "npindex", "npindex_total"),
