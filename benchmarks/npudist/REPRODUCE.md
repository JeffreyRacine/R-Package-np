...
```bash
Rscript /Users/jracine/Development/np-master/benchmarks/npudist/compare_npudist_versions.R \
...
```bash
Rscript /Users/jracine/Development/np-master/benchmarks/npudist/make_npudist_report.R \
