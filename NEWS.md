...
* Ordinary univariate generalized nearest-neighbour regression now admits
  ...
  One R-owned capability resolver supplies manual validation, fixed- and
  automatic-degree optimizer bounds, and the native lower bound; adaptive NN,
  mixed or multivariate regressors, non-GLP bases, higher-order/uniform/bounded
