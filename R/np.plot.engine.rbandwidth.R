      ...
      for (i in seq_len(bws$ndim)){
        ...
        if (common.scale){
          ...
          if (overlay.ok && !xi.factor) {
            ...
            .np_plot_overlay_points_1d(xdat[,i], ydat)
            ...
            .np_plot_overlay_points_factor(xdat[,i], ydat)
