%% $Id: np_faq.tex,v 1.97 2016/07/14 13:19:29 jracine Exp jracine $
...
is 0.60-3. Kindly update your version should you not be using the most
...
reflection approaches and \cite{MARRON_RUPPERT:1994} for alternative
...
\section*{Changes from Version 0.60-2 to 0.60-3 [29-Apr-201]}
