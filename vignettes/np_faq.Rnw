...
%\VignetteIndexEntry{Frequently Asked Questions (npRmpi)}
...
\title{Package \texttt{npRmpi} FAQ} \date{\today} \author{Jeffrey S.~Racine}
...
is 0.60-19. Kindly update your version should you not be using the most
